...
<View style={leftIcon || rightButton ? {flex: 1} : {width: '100%', minHeight: 30}}>
  <BaseInput value={value} size='md' style={{...styleInput.input, ...style}} {...props}  placeholder={placeholder} onChangeText={setValue} returnKeyType={onSubmit ?'next': 'done'} onSubmitEditing={onSubmit} ref={textInputRef} /></View>
